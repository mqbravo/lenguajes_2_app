        ...
        loginBtn.setOnClickListener(v -> {
            ...
            if(usernameGot.equals("") | passwordGot.equals("")){
               ...
               //String url = getApplicationContext().getResources().getString(R.string.url);
                String url = getApplicationContext().getResources().getString(R.string.fengHerokuServer);
               //"Jsonify" del username y password
                ...
                try {
                    ...
                    JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url.concat("/login"), payload, response -> {
                        try {
